...
class Zilla_Twitter_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$result = false;
		if( $instance['username'] ) $result = $this->getTweets($instance['username'], $instance['count']);
	...
	echo '<div class="wrap">';
		...
		echo '<form method="post" action="options.php">';
			...
			echo '<ol>';
				...
				echo '<li>' . __( 'Click the Save Changes button at the bottom of this page', 'zilla' ) . '</li>';
			echo '</ol>';
