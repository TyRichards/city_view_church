...
require_once $incdir . 'template-tags.php';
require_once $incdir . 'meta/page-meta.php';
...
require_once $incdir . 'class-tgm-plugin-activation.php';
...
function zilla_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            ...
            'source'             => 'http://themezilla-free-downloads.s3.amazonaws.com/zilla-shortcodes-2.0.1.zip', // The plugin source.
	...
	$theme_text_domain = 'zilla';

	/**
	 * Config settings
	 */
	$config = array(
		'domain'       		=> 'zilla',         	// Text domain - likely want to be the same as your theme.
		...
		'strings'      		=> array(
			'page_title'                       			=> __( 'Install Required Plugins', 'zilla' ),
			'menu_title'                       			=> __( 'Install Plugins', 'zilla' ),
			'installing'                       			=> __( 'Installing Plugin: %s', 'zilla' ), // %1$s = plugin name
			'oops'                             			=> __( 'Something went wrong with the plugin API.', 'zilla' ),
			...
			'return'                           			=> __( 'Return to Required Plugins Installer', 'zilla' ),
			'plugin_activated'                 			=> __( 'Plugin activated successfully.', 'zilla' ),
			'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'zilla' ), // %1$s = dashboard link
