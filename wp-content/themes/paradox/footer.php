...
?>
		...
		<?php zilla_footer_start(); ?>
			...
			<p><span class="copyright">&copy; <?php echo date( 'Y' ); ?> <a href="<?php echo esc_url(home_url()); ?>"><?php bloginfo( 'name' ); ?></a></span> <span class="visible-lg"> | </span> <span class="credit">Website crafted by <a href="http://paradoxcreative.com" target="_blank">Paradox</a></p>
